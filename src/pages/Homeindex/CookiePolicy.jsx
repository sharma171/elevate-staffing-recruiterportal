  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen RecruiterHome" style={{ paddingTop: "75px" }}>
        ...
        <>
          <div className="PageHeader COP">
            <div className="container">
              <h3 className="pageHeading">Cookie Policy</h3>
            </div>
          </div>
          <div class="container">
            ...
            <div className="LegalContent">
              {cookiesData.map((section, index) => (
                <div key={index} className="lSection">
                  ...
                  {/* Render Content2 Array if Exists */}
                  ...
                  {section.table && (
                    <div className="overflow-x-auto mt-4 legalTable">
                      <table className="min-w-full border border-gray-300 text-sm text-gray-700 legalTable">
                        <thead>
                          <tr className="bg-gray-100 tableRow">
                            {section.table.headers.map((header, hIndex) => (
                              <th key={hIndex} className="border px-4 py-2 text-left">
                                {header}
                              </th>
                            ))}
                          </tr>
                        ...
                        <tbody>
                          {section.table.rows.map((row, rIndex) => (
                            <tr key={rIndex} className="border-t tableDrow">
                              {row.map((cell, cIndex) => (
