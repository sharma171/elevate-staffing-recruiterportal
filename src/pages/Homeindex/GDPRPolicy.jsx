  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen RecruiterHome" style={{ paddingTop: "75px" }}>
        ...
        <>
          <div className="PageHeader GDP">
            <div className="container">
              <h3 className="pageHeading">GDPR Compliance</h3>
            </div>
          </div>
          <div class="container">
            ...
            <div className="LegalContent">
              {GdprComplaince.map((section, index) => (
                <div key={index} className="lSection">
                  {section.sections?.map((subSection, subIndex) => (
                    <div key={subIndex} className="mb-4">
                      <h3 className="LHeadings">{subSection.heading}</h3>
                      ...
                      {/* Render List Items if Exist */}
                      {subSection.listItems && (
                        <ul className="list-disc Lulist pl-5 text-gray-700">
                          {subSection.listItems.map((item, j) => (
                      ...
                      {/* Render Paragraphs After List if Exist */}
                      {subSection.paragraphsAfterList?.map((paraAfter, k) => (
