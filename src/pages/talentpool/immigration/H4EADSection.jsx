...
const H4_EAD_CATEGORY = { value: "C26", label: "C26 - H-4 Dependent" };
...
function H4EADCard({ ead, isCurrent, isEditing = false, onChange, onDelete }) {
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div className="font-medium text-gray-900">H-4 EAD Card</div>
          {eadRecords.length > 0 && (
            <Badge variant="secondary" className="text-xs">
              {eadRecords.length}
            </Badge>
      ...
      {hasNoEADs ? (
        <div className="border border-dashed rounded-lg p-8 text-center text-muted-foreground">
          ...
          <p className="font-medium mb-1">No H-4 EAD Card Data</p>
